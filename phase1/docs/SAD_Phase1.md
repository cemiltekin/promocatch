...
In Phase 1, the development view is represented by the project file organization. The system is intentionally small and modular so that each layer can evolve independently in later iterations.
